        ...
        <ul class="navbar-nav">
            ...
            <li class="nav-item">
                @can('dash.usuario.index')
                    <a class="nav-link {{ request()->is('dash/asesor/usuario') ? 'active' : '' }}"
                        href="{{ route('usuarios') }}">
            ...
            <li class="nav-item">
                @can('dash.calendario.index')
                    <a class="nav-link {{ request()->is('dash/tecnico/calendario') ? 'active' : '' }}"
            ...
            <li class="nav-item">
                @can('dash.solicitudes.index')
                    <a class="nav-link {{ request()->is('dash/asesor/solicitudes') ? 'active' : '' }}"
            ...
            <li class="nav-item">
                ...
                <a class="nav-link {{ request()->is('dash/cliente/motocicletas') ? 'active' : '' }}"
                    href="{{ route('motocicletas') }}">
                    <i class="ni ni-bulb-61 text-orange"></i>
            ...
            <li class="nav-item">
                @can('dash.solicitudes.estado')
                    <a class="nav-link {{ request()->is('dash/asesor/estadoSolicitud') ? 'active' : '' }}"
                        href="{{ route('solicitudesEstado') }}">
            ...
            <li class="nav-item">
                @can('dash.solicitudes.detalle')
                    <a class="nav-link {{ request()->is('dash/asesor/servicio') ? 'active' : '' }}"
            ...
            <li class="nav-item">
                @can('dash.reporteEstado.index')
                    <a class="nav-link {{ request()->is('dash/tecnico/reporte') ? 'active' : '' }}"
                        href="{{ route('reporte') }}">
            ...
            <li class="nav-item">
                @can('dash.reporteCuenta.index')
                    <a class="nav-link {{ request()->is('dash/tecnico/cuenta') ? 'active' : '' }}"
            ...
            <li class="nav-item">
                @can('dash.reporteCuenta.index')
                    <a class="nav-link {{ request()->is('dash/tecnico/reporte/final') ? 'active' : '' }}"
                        href="{{ route('reporteFinal') }}">
                        <i class="ni ni-archive-2 text-orange"></i>
            ...
            <li class="nav-item">
                @can('dash.repuestos.index')
                    <a class="nav-link {{ request()->is('dash/tecnico/repuestos') ? 'active' : '' }} "
                        href="{{ route('repuesto') }}">
