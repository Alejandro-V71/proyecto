            ...
            <table class="table">
                <thead>
                    <tr>
                        ...
                        <th class="text-center text-warning  bg-secondary">Reporte Final

                            <p class="text-white">Información de la motocicleta, precios y estados </p>
                        </th>
                    </tr>
                </thead>
                <tbody>
       ...
       <table class="table">
        <thead>
            <tr>
                ...
                <th class="text-center text-danger ">Estados</th>
        ...
        <tbody>
            <tr >
                <td  >
                @foreach ( $est as  $estados)
                 <p class="text-secondary"> Estado: <span class="text-dark">{{$estados->estado->tipoEstado}}</span></p>
                 <p class="text-secondary"> Fecha inicio: <span class="text-dark">{{$estados->fechaIncio}}</span></p>
                 <p class="text-secondary"> Fecha fin: <span class="text-dark">{{$estados->fechaFin}}</span></p>
